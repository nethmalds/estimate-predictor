      ...
      <div className="grid grid-cols-2 gap-6">
        <div>
          <label className={labelClass}>
            Finish Level <span className="text-red-400">*</span>
          </label>
          <select
            value={data.finish_level}
            onChange={(e) =>
              field("finish_level", e.target.value as ConstructionDetails["finish_level"])
            }
            className={`${selectClass} ${errors.finish_level ? "border-red-500" : ""}`}
          >
          ...
          {errors.finish_level && (
            <p className="text-destructive mt-1 text-xs">{errors.finish_level}</p>
          )}
        </div>

        <div>
          <label className={labelClass}>
            Structural System <span className="text-red-400">*</span>
          </label>
          <select
            value={data.structural_system}
            onChange={(e) =>
              field("structural_system", e.target.value as ConstructionDetails["structural_system"])
            }
            className={`${selectClass} ${errors.structural_system ? "border-red-500" : ""}`}
          >
            <option value="">Select...</option>
          ...
          {errors.structural_system && (
            <p className="text-destructive mt-1 text-xs">{errors.structural_system}</p>
          )}
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => field("roof_type", e.target.value as ConstructionDetails["roof_type"])}
            className={`${selectClass} ${errors.roof_type ? "border-red-500" : ""}`}
          >
            <option value="">Select...</option>
          ...
          {errors.roof_type && <p className="text-destructive mt-1 text-xs">{errors.roof_type}</p>}
        </div>

        <div>
          <label className={labelClass}>
            Ceiling Type <span className="text-red-400">*</span>
          </label>
          <select
            value={data.ceiling_type}
            onChange={(e) =>
              field("ceiling_type", e.target.value as ConstructionDetails["ceiling_type"])
            }
            className={`${selectClass} ${errors.ceiling_type ? "border-red-500" : ""}`}
          >
            <option value="">Select...</option>
          ...
          {errors.ceiling_type && (
            <p className="text-destructive mt-1 text-xs">{errors.ceiling_type}</p>
          )}
        </div>
        ...
        <div>
          ...
          <select
            value={data.soil_condition}
            onChange={(e) =>
              field("soil_condition", e.target.value as ConstructionDetails["soil_condition"])
            }
        ...
        <div>
          ...
          <select
            value={data.drainage_type}
            onChange={(e) =>
              field("drainage_type", e.target.value as ConstructionDetails["drainage_type"])
            }
            className={selectClass}
          >
            <option value="">Select...</option>
        ...
        <div>
          ...
          <select
            value={data.external_works_scope}
            onChange={(e) =>
              field(
                "external_works_scope",
                e.target.value as ConstructionDetails["external_works_scope"]
              )
            }
            className={selectClass}
          >
